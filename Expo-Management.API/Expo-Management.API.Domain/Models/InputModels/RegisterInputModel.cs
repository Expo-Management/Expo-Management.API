...
namespace Expo_Management.API.Domain.Models.InputModels
{
    public class RegisterInputModel
    {
        ...
        [StringLength(30, ErrorMessage = "El correo debe de ser entre 10 y 100 caracteres.")]
        public string Position { get; set; } = default!;

        [StringLength(50, ErrorMessage = "El correo debe de ser entre 10 y 100 caracteres.")]
