...
namespace Expo_Management.API.Infraestructure.Migrations
{
    ...
    [Migration("20220830221008_AllDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Expo_Management.API.Domain.Models.Entities.FilesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Expo_Management.API.Domain.Models.Entities.JudgeRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Expo_Management.API.Domain.Models.Entities.ProjectModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Expo_Management.API.Domain.Models.Entities.Claim", b =>
                {
                    b.HasOne("Expo_Management.API.Domain.Models.Entities.ProjectModel", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("Expo_Management.API.Domain.Models.Entities.ProjectModel", b =>
                {
                    ...
                    b.HasOne("Expo_Management.API.Domain.Models.Entities.FilesModel", "Files")
                        .WithMany()
            ...
            modelBuilder.Entity("MentionProjectModel", b =>
                {
                    ...
                    b.HasOne("Expo_Management.API.Domain.Models.Entities.ProjectModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Expo_Management.API.Domain.Models.Entities.User", b =>
                {
                    b.HasOne("Expo_Management.API.Domain.Models.Entities.FilesModel", "ProfilePicture")
                        .WithMany()
